...
private:
  ...
  static int readdir_r_p(void *ctx, DIR *pdir, struct dirent *entry,
  ...
  //
  static int external_read(const struct lfs_config *c, lfs_block_t block,
                           lfs_off_t off, void *buffer, lfs_size_t size);
  static int external_prog(const struct lfs_config *c, lfs_block_t block,
  ...
  //
  static int internal_read(const struct lfs_config *c, lfs_block_t block,
                           lfs_off_t off, void *buffer, lfs_size_t size);
  static int internal_prog(const struct lfs_config *c, lfs_block_t block,
                           lfs_off_t off, const void *buffer, lfs_size_t size);
